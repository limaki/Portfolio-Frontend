...
export class IndexComponent{
  ...
  ButtonEdit(){
    ...
    this.myPortfolio.serviceInitial = 'Alejandro El Grande';
   
  
    let textBackInitial = document.querySelector<HTMLElement>('#Text-Initial')!;
    textBackInitial.style.color = 'white';
  
    this.myPortfolio.service = '';
  
  
    this.myPortfolio.name = 'Quiero morir grande como alejandro';
    this.myPortfolio.ocupation = 'Expansión y legado Indo-Ario gen R1a';
  
  
    let amorMio = document.querySelector<HTMLElement>('#amor')!;
    amorMio.style.display = 'block';
    let suAmor = document.querySelector<HTMLElement>('#suAmor')!;
    suAmor.style.display = 'none';
  
  
  
    let InitialBackgroud = document.querySelector<HTMLElement>('.background-initial')!;
    InitialBackgroud.style.background = 'none';
  
    InitialBackgroud.className += ' background-initial-one';
  
  
  
    let EditButtonPerson = document.querySelector<HTMLElement>('.button-EditPrimaryPerson')!;
    EditButtonPerson.style.display = 'none';
  
    let ButtonEditOcultPerson = document.querySelector<HTMLElement>('#ButtonOcultPersonEdit')!;
    ButtonEditOcultPerson.style.display = 'block';
    
    
  
    let ButtonEnterResume = document.querySelector<HTMLElement>('.holanda')!;
    ButtonEnterResume.style.marginLeft = '40%';
  
  
    this.myPortfolio.background = 'blue';
  ...
  DeleteColorBack(){
    ...
    this.myPortfolio.background = '' + 'background: ';

    let OcultarButton = document.querySelector<HTMLElement>('#BotonBack')!;
  ...
  agreegeNameBaner(value: string) { this.myPortfolio.service = value; }
  
  agreegeNamePerfil(value: string) { this.myPortfolio.name = value; }
  
  agreegeDescriptionPerfil(value: string) { this.myPortfolio.ocupation = value; }
  
  agreegeBackground(value: string){this.myPortfolio.background += value
  
    let VisibleButtonBack = document.querySelector<HTMLElement>('#BotonBack')!;
    VisibleButtonBack.style.display = 'block'
